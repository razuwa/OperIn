<?php
session_start();
require 'require/koneksi.php'; // 1. Hubungkan ke database menggunakan $koneksi

// 2. Ambil data dari database dan gabungkan (JOIN) dengan tabel fakultas untuk mendapatkan namanya
...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        // Gunakan ID produk dari database sebagai indeks array agar link detailProduk.php?id= tidak rusak
        $products[$row['id']] = $row; 
    }
}
?>
